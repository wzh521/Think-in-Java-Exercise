...
//    static void display(Iterator<Pet> it) { while(it.hasNext()) {
//        Pet p = it.next(); System.out.print(p.id() + ":" + p + " ");
//    }
//        System.out.println();
//    }
//    static void display(Collection<Pet> pets) { for(Pet p : pets)
//        System.out.print(p.id() + ":" + p + " "); System.out.println();
//    }
//
//
//    public int size() { return pets.length; } public Iterator<Pet> iterator() {
//        return new Iterator<Pet>() { private int index;
//            public boolean hasNext() { return index < pets.length;
//            }
//            public Pet next() { return pets[index++]; } public void remove() { // Not implemented
...
//        return true;
//    }
//    public boolean isEmpty() { return pets.length == 0; } public boolean remove(Object o) {
//    throw new UnsupportedOperationException();
//}
...
//
//        System.arraycopy(pets, 0, result, 0, pets.length); return result;
//                }
...
//                T[] result = a;
//                System.arraycopy(pets, 0, result, 0, pets.length); if (result.length > pets.length)
//                result[pets.length] = null; return result;
//                }
//}
public class Thirty {
    public static void main(String[] args) {
//        CollectionSequence2 c = new CollectionSequence2();
// CollectionSequence2.display(c); CollectionSequence2.display(c.iterator());
// System.out.println(
