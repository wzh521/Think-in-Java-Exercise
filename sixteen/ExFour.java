...
public class ExFour {
    ...
    public static void main(String[] args) {
        double[][][] threeD =
                threeDDoubleArray(4, 6, 2, 47.0, 99.0); printArray(threeD);
        System.out.println("**********************");
        double[][][] threeD2 =
                threeDDoubleArray(2, 2, 5, 47.0, 99.0); printArray(threeD2);
        System.out.println("**********************");
        double[][][] threeD3 =
                threeDDoubleArray(9, 5, 7, 47.0, 99.0); printArray(threeD3);
