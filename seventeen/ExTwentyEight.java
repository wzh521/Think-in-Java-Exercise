...
class Tuple {
    public static class T2<A,B> implements Comparable<T2<A,B>> {
        ...
        public boolean equals(Object obj) {
            ...
            T2<A,B> o = (T2<A,B>)obj;
            return (first == null ?
                    o.first == null : first.equals(o.first)) && (second == null ?
    ...
    public static class T3<A,B,C> implements Comparable<T3<A,B,C>> {
        ...
        public boolean equals(Object obj) {
            ...
            return (third == null ?
                    o.third == null : third.equals(o.third)) && tuple.equals(o.tuple);
        }
            return false;
        }
        @SuppressWarnings("unchecked")
    ...
    public static class T4<A,B,C,D> implements Comparable<T4<A,B,C,D>> {
        ...
        public int hashCode() {
            int result = tuple.hashCode(); if(fourth != null)
                result = result * 37 + fourth.hashCode(); return result;
        }
        public boolean equals(Object obj) {
            ...
            return (fourth == null ?
                    o.fourth == null : fourth.equals(o.fourth)) && tuple.equals(o.tuple);
        }
            return false;
        }
        @SuppressWarnings("unchecked")
    ...
    public static class T5<A,B,C,D,E> implements Comparable<T5<A,B,C,D,E>> {
        private final T4<A,B,C,D> tuple; private final E fifth;
        public T5(A a, B b, C c, D d, E e) { tuple = new T4<A,B,C,D>(a, b, c, d); fifth = e;
        }
        public String toString() {
            return "(" + tuple.getFirst() + ", " + tuple.getSecond() + ", " + tuple.getThird() + ", " + tuple.getFourth() + ", " + fifth + ")";
        }
        public int hashCode() {
            int result = tuple.hashCode(); if(fifth != null)
                result = result * 37 + fifth.hashCode(); return result;
        }
        public boolean equals(Object obj) { if(obj instanceof T5) {
        ...
        public A getFirst() { return tuple.getFirst(); } public B getSecond() { return tuple.getSecond(); } public C getThird() { return tuple.getThird(); } public D getFourth() { return tuple.getFourth(); } public E getFifth() { return fifth; }
    }
    public static <A,B> T2<A,B> tuple(A a, B b) { return new T2<A,B>(a, b);
    }
    public static <A,B,C> T3<A,B,C> tuple(A a, B b, C c) { return new T3<A,B,C>(a, b, c);
    }
