...
public class ExFive {
    public static void main(String[] args) {
        ...
        char u = 'a'; System.out.println("u = 'a'");
        f.format("s: %1$-#10s\n", u);
        f.format("c: %1$-10c\n", u);
        f.format("b: %1$-10.10b\n", u);
        f.format("h: %1$-10.10h\n", u); int v = 1000;
        ...
        f.format("x: %1$-#10x\n", v);
        f.format("h: %1$-10.10h\n", v);
        BigInteger w = new BigInteger("50000000000000"); System.out.println("w = new BigInteger(\"50000000000000\")"); f.format("d 1: %1$(,0+10d\n", w);
        f.format("d 2: %1$-(, 10d\n", w);
        ...
        double x = 179.543; System.out.println("x = 179.543");
        f.format("b: %1$-10.10b\n", x);
        f.format("s: %1$#-10.10s\n", x);
        ...
        f.format("h: %1$-10.10h\n", x); Object y = new Object(); System.out.println("y = new Object()"); f.format("b: %1$-10.10b\n", y);
        f.format("s: %1$#-10.10s\n", y);
        f.format("h: %1$-10.10h\n", y); boolean z = false;
        System.out.println("z = false"); f.format("b: %1$-10.10b\n", z);
        f.format("s: %1$#-10.10s\n", z);
